...
class Warehouse:
    def __init__(self, n, m, start1, start2, start3, goal1, goal2, goal3):
        self.n = n
        self.m = m
        self.start = [start1, start2, start3]
        ...
        self.agentsPos = [start1, start2, start3]
    ...
    def reset(self):
        ...
        self.agentsPos = [self.start[0], self.start[1], self.start[2]]
