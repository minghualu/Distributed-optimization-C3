...
class Warehouse:
    ...
    def updatePos(self, resultingPos, agent_nr):
    ...
    def step(self, action, agent_nr):
        ...
        if not self.offGridMove(resultingPos, currentPos):
            ...
            self.updatePos(resultingPos, agent_nr)
            return self.agentsPos[agent_nr], reward, self.isTerminalState(resultingPos, agent_nr), None
        else:
            reward = -1
            return self.agentsPos[agent_nr], reward, self.isTerminalState(currentPos, agent_nr), None
